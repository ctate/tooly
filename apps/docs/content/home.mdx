...
import { AiLogo } from '@tooly/ui/logos/ai'
import { OpenAiLogo } from '@tooly/ui/logos/openai'
import { AnthropicLogo } from '@tooly/ui/logos/anthropic'
...
<h1 className="text-6xl font-bold">APIs as AI Tools</h1>

Tooly packages popular APIs into agent-ready tools — designed to work out of the box with OpenAI, Anthropic, and the AI SDK
...
<h2 className="text-4xl font-bold">Supported Frameworks</h2>
...
Works with all major AI frameworks
      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-3 md:max-w-[48rem]">
        <div className="flex flex-col items-center justify-center p-6 text-center rounded-lg border bg-card text-card-foreground shadow-sm">
          <AiLogo className="h-12 w-auto mb-2" />
