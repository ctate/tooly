...
Explore practical examples of using Tooly packages with the AI SDK and other AI frameworks. These examples demonstrate common patterns and best practices for AI-powered applications.

## Email Automation with AI SDK
...
## Project Management with AI SDK
...
## Multi-Tool Integration with AI SDK
...
- [🚀 Getting Started](/docs/getting-started) - Basic setup guide with AI SDK
