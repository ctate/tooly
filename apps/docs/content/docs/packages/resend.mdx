...
The `@tooly/resend` package provides AI-ready email functionality powered by the Resend API. Built specifically for the Vercel AI SDK, it's perfect for transactional emails, notifications, and automated communication in AI applications.
