...
The `@tooly/linear` package provides AI-ready project management functionality powered by the Linear API. Built specifically for the AI SDK, it's perfect for issue tracking, project management, and team collaboration in AI applications.
