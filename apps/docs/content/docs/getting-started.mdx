...
Get up and running with Tooly in just a few steps. This guide will walk you through installing your first package and integrating it with your AI application.
...
try {
  const result = await executeFunction("sendEmail", {
    to: "invalid-email", // This will throw a validation error
    subject: "Test",
    html: "<p>Hello!</p>"
  });
} catch (error) {
