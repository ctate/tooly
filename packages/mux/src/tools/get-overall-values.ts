import type { GetOverallValuesParams, GetOverallValuesResponse } from '../types.js'

export const getOverallValuesTool = {
  name: 'getOverallValues',
 ...
 * Get Overall values
 */
export async function getOverallValues(
  apiKey: string,
  baseUrl: string,
  params: GetOverallValuesParams
): Promise<GetOverallValuesResponse> {
  try {
    const url = new URL('/data/v1/metrics/{METRIC_ID}/overall', baseUrl)
