import type { GetMonitoringBreakdownParams, GetMonitoringBreakdownResponse } from '../types.js'

export const getMonitoringBreakdownTool = {
  name: 'getMonitoringBreakdown',
 ...
 */
export async function getMonitoringBreakdown(
  apiKey: string,
  baseUrl: string,
  params: GetMonitoringBreakdownParams
): Promise<GetMonitoringBreakdownResponse> {
  try {
    const url = new URL('/data/v1/monitoring/metrics/{MONITORING_METRIC_ID}/breakdown', baseUrl)
